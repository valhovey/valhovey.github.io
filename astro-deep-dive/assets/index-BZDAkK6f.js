...
`)+`
`+f);const S=w+m+a,E=w+f+o,L=Ru(r,r.VERTEX_SHADER,S),P=Ru(r,r.FRAGMENT_SHADER,E);r.attachShader(g,L),r.attachShader(g,P),e.index0AttributeName!==void 0?r.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function T(x){if(i.debug.checkShaderErrors){const k=r.getProgramInfoLog(g).trim(),O=r.getShaderInfoLog(L).trim(),W=r.getShaderInfoLog(P).trim();let j=!0,z=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,g,L,P);else{const J=Cu(r,L,"vertex"),q=Cu(r,P,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
